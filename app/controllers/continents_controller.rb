class ContinentsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to continents_path, status: :see_other, notice: "Continent was successfully destroyed." }
  ...
  private
    ...
    def set_continent
      @continent = Continent.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def continent_params
      params.expect(continent: [ :name ])
    end
end
