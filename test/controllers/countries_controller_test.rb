...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference("Country.count") do
      post countries_url, params: { country: { continent_id: @country.continent_id, name: @country.name } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { continent_id: @country.continent_id, name: @country.name } }
