...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference("Coach.count") do
      post coaches_url, params: { coach: { birthdate: @coach.birthdate, country_id: @coach.country_id, name: @coach.name } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { birthdate: @coach.birthdate, country_id: @coach.country_id, name: @coach.name } }
