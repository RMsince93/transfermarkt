...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference("Season.count") do
      post seasons_url, params: { season: { end_year: @season.end_year, name: @season.name, start_year: @season.start_year } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { end_year: @season.end_year, name: @season.name, start_year: @season.start_year } }
